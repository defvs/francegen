...
1. Install the Rust toolchain and collect GeoTIFFs that share the same projected coordinate system (e.g., LAMB93). DEM data from IGN is recommended: [Download here](https://cartes.gouv.fr/telechargement/IGNF_MNT-LIDAR-HD)
...
3. Get DEM data from [cartes.gouv.fr](https://cartes.gouv.fr/telechargement/IGNF_MNT-LIDAR-HD)
