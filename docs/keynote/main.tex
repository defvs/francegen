...
\titlegraphic{%
  \includegraphics[height=0.45\textheight]{puydedome.jpg}%
}
...
\begin{frame}{From Idea to Terrain}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.5\textheight]{keynote/minecraft_ski.jpg}
...
\begin{frame}{Problem: Tiny Minecraft Mountains}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.6\textheight]{keynote/minecraft_regular_mountains.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Trigger: IGN LIDAR-HD}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.55\textheight]{keynote/lidarhd_example.jpg}
...
\begin{frame}{GIS Basics}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.4\textwidth}
      \begin{center}
        \includegraphics[width=\linewidth]{keynote/what_is_gis.jpg}
      \end{center}
  \end{columns}
\end{frame}
...
\begin{frame}{Overpass API and QL}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.45\textheight]{keynote/overpass.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{First Prototype: WorldPainter}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.6\textheight]{keynote/worldpainter_screenshot.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Terrain from DEMs}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.6\textheight]{keynote/2alpes_heightmap.jpg}
...
\begin{frame}{OpenStreetMap Data}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=0.6\textheight]{keynote/2alpes_osm.jpg}
...
\begin{frame}{Landcover and Biomes}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.5\textwidth}
      \begin{center}
        \includegraphics[width=0.6\linewidth]{keynote/cosia_datasheet.jpg}
      \end{center}
  \end{columns}

  \begin{center}
    \includegraphics[width=0.38\textwidth]{keynote/2alpes_wmts_cosia.jpg}
...
\begin{frame}{Point Clouds to Buildings}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.55\textwidth]{keynote/2alpes_lidar.jpg}
...
\begin{frame}[fragile]{Configuration and Customization}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{keynote/json_configuration.jpg}
  \end{center}
\end{frame}
...
\begin{frame}[plain]
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{2alpes_from_west.jpg}}
\end{frame}

\begin{frame}[plain]
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{venosc.jpg}}
\end{frame}

\begin{frame}[plain]
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{vallon_du_diable_selle.jpg}}
\end{frame}

\begin{frame}[plain]
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{puydedome_raw.jpg}}
\end{frame}

\begin{frame}[plain]
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{2alpes_lidar_buildings.jpg}}
\end{frame}

\begin{frame}[plain]
    \makebox[\linewidth]{\includegraphics[width=\paperwidth]{paris_lidar_buildings.jpg}}
\end{frame}
